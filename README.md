...
📄 See [JFSD Notes](https://1drv.ms/o/c/afa8f9abec30f20c/EptGQoGw_ypPqvc7iXzlYCYBhETTX_wexpY3YpIS1dktag) for detailed notes.
    Once See this link [Notes](https://java-full-stack-notes-six.vercel.app/)
...
## Getting Started
You can start a Spring Boot project using [Spring Initializr](https://start.spring.io) and follow along with the notes.
